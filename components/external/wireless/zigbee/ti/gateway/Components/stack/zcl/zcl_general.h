 ...
 */
#define zclGeneral_SendBasicResetFactoryDefaults(a,b,c,d) \
	zcl_SendCommand( (a), (b), ZCL_CLUSTER_ID_GEN_BASIC, COMMAND_BASIC_RESET_FACT_DEFAULT, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, (c), 0, (d), 0, NULL )
#endif // ZCL_BASIC
 ...
 */
#define zclGeneral_SendIdentifyQuery(a,b,c,d) \
	zcl_SendCommand( (a), (b), ZCL_CLUSTER_ID_GEN_IDENTIFY, COMMAND_IDENTIFY_QUERY, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, (c), 0, (d), 0, NULL )
#endif // ZCL_IDENTIFY
 ...
 */
#define zclGeneral_SendGroupAdd(a,b,c,d,e,f) \
	zclGeneral_SendAddGroupRequest( (a), (b), COMMAND_GROUP_ADD, (c), (d), (e), (f) )
 ...
 */
#define zclGeneral_SendGroupView(a,b,c,d,e) \
	zclGeneral_SendGroupRequest( (a), (b), COMMAND_GROUP_VIEW, (c), (d), (e) )
 ...
 */
#define  zclGeneral_SendGroupGetMembership(a,b,c,d,e,f) \
	zclGeneral_SendGroupGetMembershipRequest( (a), (b), COMMAND_GROUP_GET_MEMBERSHIP, FALSE, ZCL_FRAME_CLIENT_SERVER_DIR, 0, (c), (d), (e), (f) )
 ...
 */
#define zclGeneral_SendGroupRemove(a,b,c,d,e) \
	zclGeneral_SendGroupRequest( (a), (b), COMMAND_GROUP_REMOVE, (c), (d), (e) )
 ...
 */
#define zclGeneral_SendGroupRemoveAll(a,b,c,d) \
	zcl_SendCommand( (a), (b), ZCL_CLUSTER_ID_GEN_GROUPS, COMMAND_GROUP_REMOVE_ALL, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, (c), 0, (d), 0, NULL )
 ...
 */
#define zclGeneral_SendGroupAddIfIdentifying(a,b,c,d,e,f) \
	zclGeneral_SendAddGroupRequest( (a), (b), COMMAND_GROUP_ADD_IF_IDENTIFYING, (c), (d), (e), (f) )
 ...
 */
#define zclGeneral_SendGroupAddResponse(a,b,c,d,e,f) \
	zclGeneral_SendGroupResponse( (a), (b), COMMAND_GROUP_ADD_RSP, (c), (d), (e), (f) )
 ...
 */
#define  zclGeneral_SendGroupGetMembershipResponse(a,b,c,d,e,f,g) \
	zclGeneral_SendGroupGetMembershipRequest( (a), (b), COMMAND_GROUP_GET_MEMBERSHIP_RSP, TRUE, ZCL_FRAME_SERVER_CLIENT_DIR, (c), (d), (e), (f), (g) )
 ...
 */
#define zclGeneral_SendGroupRemoveResponse(a,b,c,d,e,f) \
	zclGeneral_SendGroupResponse( (a), (b), COMMAND_GROUP_REMOVE_RSP, (c), (d), (e), (f) )
#endif // ZCL_GROUPS
 ...
 */
#define zclGeneral_SendAddScene(a,b,c,d,e) \
	zclGeneral_SendAddSceneRequest( (a), (b), COMMAND_SCENE_ADD, (c), (d), (e) )
 ...
 */
#define zclGeneral_SendSceneView(a,b,c,d,e,f) \
	zclGeneral_SendSceneRequest( (a), (b), COMMAND_SCENE_VIEW, (c), (d), (e), (f) )
 ...
 */
#define zclGeneral_SendSceneRemove(a,b,c,d,e,f) \
	zclGeneral_SendSceneRequest( (a), (b), COMMAND_SCENE_REMOVE, (c), (d), (e), (f) )
 ...
 */
#define zclGeneral_SendSceneStore(a,b,c,d,e,f) \
	zclGeneral_SendSceneRequest( (a), (b), COMMAND_SCENE_STORE, (c), (d), (e), (f) )
 ...
 */
#define zclGeneral_SendSceneRecall(a,b,c,d,e,f) \
	zclGeneral_SendSceneRequest( (a), (b), COMMAND_SCENE_RECALL, (c), (d), (e), (f) )
 ...
 */
#define zclGeneral_SendSceneRemoveAll(a,b,c,d,e) \
	zclGeneral_SendSceneRequest( (a), (b), COMMAND_SCENE_REMOVE_ALL, (c), 0, (d), (e) )
 ...
 */
#define zclGeneral_SendSceneGetMembership(a,b,c,d,e) \
	zclGeneral_SendSceneRequest( (a), (b), COMMAND_SCENE_GET_MEMBERSHIP, (c), 0, (d), (e) )
 ...
 */
#define zclGeneral_SendSceneAddResponse(a,b,c,d,e,f,g) \
	zclGeneral_SendSceneResponse( (a), (b), COMMAND_SCENE_ADD_RSP, (c), (d), (e), (f), (g) )
 ...
 */
#define zclGeneral_SendSceneViewResponse(a,b,c,d,e,f) \
	zclGeneral_SendSceneViewRsp( (a), (b), COMMAND_SCENE_VIEW_RSP, (c), (d), (e), (f) )
 ...
 */
#define zclGeneral_SendSceneRemoveResponse(a,b,c,d,e,f,g) \
	zclGeneral_SendSceneResponse( (a), (b), COMMAND_SCENE_REMOVE_RSP, (c), (d), (e), (f), (g) )
 ...
 */
#define zclGeneral_SendSceneRemoveAllResponse(a,b,c,d,e,f) \
	zclGeneral_SendSceneResponse( (a), (b), COMMAND_SCENE_REMOVE_ALL_RSP, (c), (d), 0, (e), (f) )
 ...
 */
#define zclGeneral_SendSceneStoreResponse(a,b,c,d,e,f,g) \
	zclGeneral_SendSceneResponse( (a), (b), COMMAND_SCENE_STORE_RSP, (c), (d), (e), (f), (g) )
 ...
 */
#define zclGeneral_SendEnhancedAddScene(a,b,c,d,e) \
	zclGeneral_SendAddSceneRequest( (a), (b), COMMAND_SCENE_ENHANCED_ADD, (c), (d), (e) )
 ...
 */
#define zclGeneral_SendSceneEnhancedView(a,b,c,d,e,f) \
	zclGeneral_SendSceneRequest( (a), (b), COMMAND_SCENE_ENHANCED_VIEW, (c), (d), (e), (f) )
 ...
 *      ZStatus_t zclGeneral_SendSceneAddResponse( uint16 srcEP, afAddrType_t *dstAddr, uint8 status, uint16 groupID, uint8 sceneID, uint8 disableDefaultRsp, uint8 seqNum );
 */
#define zclGeneral_SendSceneEnhancedAddResponse(a,b,c,d,e,f,g) \
	zclGeneral_SendSceneResponse( (a), (b), COMMAND_SCENE_ENHANCED_ADD_RSP, (c), (d), (e), (f), (g) )
 ...
 */
#define zclGeneral_SendSceneEnhancedViewResponse(a,b,c,d,e,f) \
	zclGeneral_SendSceneViewRsp( (a), (b), COMMAND_SCENE_ENHANCED_VIEW_RSP, (c), (d), (e), (f) )
 ...
 */
#define zclGeneral_SendOnOff_CmdOff(a,b,c,d) \
	zcl_SendCommand( (a), (b), ZCL_CLUSTER_ID_GEN_ON_OFF, COMMAND_OFF, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, (c), 0, (d), 0, NULL )
 ...
 */
#define zclGeneral_SendOnOff_CmdOn(a,b,c,d) \
	zcl_SendCommand( (a), (b), ZCL_CLUSTER_ID_GEN_ON_OFF, COMMAND_ON, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, (c), 0, (d), 0, NULL )
 ...
 */
#define zclGeneral_SendOnOff_CmdToggle(a,b,c,d) \
 ...
 */
#define zclGeneral_SendOnOff_CmdOnDuration(a,b,c,d,e) \
	zcl_SendCommand( (a), (b), ZCL_CLUSTER_ID_GEN_ON_OFF, COMMAND_ON_DURATION, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, (d), 0, (e), 2, (c) )
 ...
 */
#define zclGeneral_SendOnOff_CmdOnWithRecallGlobalScene(a,b,c,d) \
	zcl_SendCommand( (a), (b), ZCL_CLUSTER_ID_GEN_ON_OFF, COMMAND_ON_WITH_RECALL_GLOBAL_SCENE, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, (c), 0, (d), 0, NULL )
#endif // ZCL_LIGHT_LINK_ENHANCE
#endif // ZCL_ON_OFF
 ...
 */
#define zclGeneral_SendLevelControlMoveToLevel(a,b,c,d,e,f) \
 ...
 */
#define zclGeneral_SendLevelControlMove(a,b,c,d,e,f) \
 ...
 */
#define zclGeneral_SendLevelControlStep(a,b,c,d,e,f,g) \
 ...
 */
#define zclGeneral_SendLevelControlStop(a,b,c,d) \
	zcl_SendCommand( (a), (b), ZCL_CLUSTER_ID_GEN_LEVEL_CONTROL, COMMAND_LEVEL_STOP, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, (c), 0, (d), 0, NULL )
 ...
 */
#define zclGeneral_SendLevelControlMoveToLevelWithOnOff(a,b,c,d,e,f) \
 ...
 */
#define zclGeneral_SendLevelControlMoveWithOnOff(a,b,c,d,e,f) \
 ...
 */
#define zclGeneral_SendLevelControlStepWithOnOff(a,b,c,d,e,f,g) \
 ...
 */
#define zclGeneral_SendLevelControlStopWithOnOff(a,b,c,d) \
	zcl_SendCommand( (a), (b), ZCL_CLUSTER_ID_GEN_LEVEL_CONTROL, COMMAND_LEVEL_STOP_WITH_ON_OFF, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, (c), 0, (d), 0, NULL )
 ...
 */
#define zclGeneral_SendAlarmResetAll(a,b,c,d) \
	zcl_SendCommand( (a), (b), ZCL_CLUSTER_ID_GEN_ALARMS, COMMAND_ALARMS_RESET_ALL, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, (c), 0, (d), 0, NULL )
 ...
 */
#define zclGeneral_SendAlarmGet(a,b,c,d) \
	zcl_SendCommand( (a), (b), ZCL_CLUSTER_ID_GEN_ALARMS, COMMAND_ALARMS_GET, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, (c), 0, (d), 0, NULL )
 ...
 */
#define zclGeneral_SendAlarmResetLog(a,b,c,d) \
	zcl_SendCommand( (a), (b), ZCL_CLUSTER_ID_GEN_ALARMS, COMMAND_ALARMS_RESET_LOG, TRUE, ZCL_FRAME_CLIENT_SERVER_DIR, (c), 0, (d), 0, NULL )
#endif // ZCL_ALARMS
 ...
 */
#define zclGeneral_SendLocationDataResponse(a,b,c,d,e) \
 ...
 */
#define zclGeneral_SendLocationDataNotif(a,b,c,d) \
 ...
 */
#define zclGeneral_SendLocationDataCompactNotif(a,b,c,d) \
 ...
 */
#define zclGeneral_SendRSSIPing(a,b,c,d,e) \
	zcl_SendCommand( (a), (b), ZCL_CLUSTER_ID_GEN_LOCATION, COMMAND_LOCATION_RSSI_PING, TRUE, ZCL_FRAME_SERVER_CLIENT_DIR, (d), 0, (e), 1, (c) )
#endif // ZCL_LOCATION
