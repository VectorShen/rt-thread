...
apisSysParams_t sysParams;
    ...
    configTableItem_t configItems[] =
    {
        ...
        { (void *)&gMAX_RREQ_ENTRIES, "MAX_RREQ_ENTRIES", TYPE_UINT16, 1 },
        ...
        { (void *)&gMAX_BCAST, "MAX_BCAST", TYPE_UINT16, 1 },
        { (void *)&gAPS_MAX_GROUPS, "APS_MAX_GROUPS", TYPE_UINT8, 1 },
        { (void *)&gMAX_RTG_ENTRIES, "MAX_RTG_ENTRIES", TYPE_UINT16, 1 },
        { (void *)&gNWK_MAX_BINDING_ENTRIES, "NWK_MAX_BINDING_ENTRIES", TYPE_UINT16, 1 },
        { (void *)&gMAX_BINDING_CLUSTER_IDS, "MAX_BINDING_CLUSTER_IDS", TYPE_UINT8, 1 },
        { (void *)&defaultKey, "DEFAULT_KEY", TYPE_UINT8, 16 },
        ...
        { (void *)&gMAX_NEIGHBOR_ENTRIES,"MAX_NEIGHBOR_ENTRIES", TYPE_UINT16, 1 },
        { (void *)&gMAX_RTG_SRC_ENTRIES, "MAX_RTG_SRC_ENTRIES", TYPE_UINT16, 1 },
